...
public class ExampleUnitTest {
    ...
    public void getLocationsByTripTest() {
        ...
        LocatorService locatorService = retrofit.create(LocatorService.class);
        Call<List<Lokacija>> returnedLocations = locatorService.getAllLocationsInATrip(4L);
    ...
    private String authToken="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..8g634lFwQLmsd8-FsTNLbPKS5q-EaTTQij7LnA8YVTM";
